        ...
        .then((campsite) => {
          if (campsite && campsite.comments.id(req.params.commentId)) {
            if (
              ...
              err = new Error(
                `You are not authorized to perform this action since you are not author for this comment`
              );
              err.status = 403;
              return next(err);
            }
        ...
        .then((campsite) => {
          if (campsite && campsite.comments.id(req.params.commentId)) {
            if (
              ...
              err = new Error(
                `You are not authorized to perform since you are not the author for this comment`
              );
              err.status = 403;
              return next(err);
            }
